...
public class UserRecBook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestQueue =  MyVolleySingletonUtil.getInstance(UserRecBook.this).getRequestQueue();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UserRecBook.this, AdminListsBooks.class);
        ...
        btnAddGenre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter arrayAdapter = new ArrayAdapter(UserRecBook.this, android.R.layout.simple_spinner_item, genres);
    ...
    public void addBook(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.43.3:9080/app/bookCard/add", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(UserRecBook.this, error.toString(), Toast.LENGTH_LONG).show();
            }
        }){
            @Nullable
            @Override
    ...
    public void getGenres(){
        ...
        JsonArrayRequest jsonArrayRequest
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try{
                        ...
                        e.printStackTrace();
                        Toast.makeText(UserRecBook.this, "Something went wrong", Toast.LENGTH_LONG).show();
                    }
                }
            }
        }, new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(UserRecBook.this, "Failed to get incomes", Toast.LENGTH_LONG).show();
